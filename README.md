...
$ ./build.sh
$ sudo fanocli --deploy-http=fano-app.fano
$ ./bin/app.cgi
```
...
You can access application directly from web browser. Alternatively you can run application behind web server as reverse proxy.
### Run with a webserver as reverse proxy

Setup a virtual host. Please consult documentation of web server you use.

#### Apache

You need to have `mod_proxy_http` installed and loaded. This module is Apache's built-in module, so it is very likely that you will have it with your Apache installation. You just need to make sure it is loaded. For example, on Debian,
